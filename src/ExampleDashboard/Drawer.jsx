...
import './all.css';  // Make sure to create an appropriate CSS file to style your component
import 'material-icons/iconfont/material-icons.css'; // Ensure you have the material icons CSS
import{Link} from 'react-router-dom';
import Dash from '../Dashboards/dashboard';
    ...
    <div >
     ...
     <div className="mdc-drawer__content">
       ...
       <div className="mdc-list-group">
         ...
         <div className={`mdc-list-item mdc-drawer-item ${view === 'dashboard' ? 'active' : ''}`}>
             ...
             <div className={`mdc-list-item mdc-drawer-item ${view === 'procurement' ? 'active' : ''}`}>
